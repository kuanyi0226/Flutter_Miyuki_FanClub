...
enum FetchType { STRING, NUMBER, BOOLEAN, JSON }
...
class RemoteConfigService {
  ...
  void _initRemoteConfig(
    ...
    try {
      ...
      await _remoteConfig.setConfigSettings(RemoteConfigSettings(
        fetchTimeout: Duration(seconds: fetchTimeoutSecond),
        minimumFetchInterval: Duration(
            seconds: minimumFetchIntervalSecond), // Always fetch fresh data
      ));
  ...
  List<String> defaultSongList() {
    return [
      ...
      'F.O.',
      'FU-JI-TSU',
      'Good_Morning,_Ms.Castaway',
      'Good_Morning,_Ms.YAMASHINA',
      'HALF',
      'I_Love_You，答えてくれ',
      'I_am',
      'I_love_him',
