    ...
    if (year_index.startsWith('y')) {
      ...
      switch (year_index) {
        ...
        case "1987_0":
          return 'SUPPIN VOL.1';
        case "1987_1":
          return 'Tour Special「SUPPIN VOL.1」';
        case "1989_0":
          return '野ウサギのように';
        case "1990_0":
          return 'Night Wings';
        ...
        case "1995_1":
          return 'Tour Final「LOVE OR NOTHING」';
        case "1997_0":
          return 'パラダイス・カフェ';
        case "1998_0":
          return 'TOUR \'98 試行錯誤';
        case "2001_0":
          return 'ＸＸＩc. 1st. 中島みゆき';
        case "2001_1":
          return 'XXIc. 1st. 中島みゆき in KEIO';
        case "2005_0":
          return 'TOUR 2005';
        case "2006_0":
          return '吉田拓郎＆かぐや姫 Concert in つま恋 2006';
        case "2007_0":
          return 'TOUR 2007 歌旅';
        case "2010_0":
          return 'TOUR 2010';
    ...
    switch (yakai) {
      ...
      case "y2000":
        return [
          ...
          '11	氷脈 (中島)',
          '//38	足の下に何かがあるので(詩篇) (槲)',
          '//39	地下から陽時計を見上げれば(詩篇) (谷山)',
          '//40	ヤコブの梯子(詩篇) (妻の声)',
          '//41	成就(詩篇) (司祭の声、谷山、槲、妻の声)',
          '12	水琴窟 （Instrumental）',
          ...
          '17	六花 (中島、谷山)',
          '//48	帳簿(詩篇) (谷山)',
          '//49	地吹雪を御存知ない(詩篇) (槲、中島)',
          '[text]第６場	迷子',
          '18	粉雪は忘れ薬 (中島)',
          '[text]──カーテンコール──',
          '19 凍原楼閣 （Instrumental）'
        ];
      case "y2002":
        return [
          '[text]＜第一幕＞	GLASSHOUSE・夏',
          ...
          '12	氷脈 (中島、杉本)',
          '//38	足の下に何かがあるので(詩篇) (槲)',
          '//39	地下から陽時計を見上げれば(詩篇) (香坂)',
          '//40	ヤコブの梯子(詩篇) (妻の声)',
          '//41	成就(詩篇) (司祭の声、香坂、槲、妻の声)',
          '13	水琴窟 （Instrumental）',
      ...
      case "y2004":
        return [
          ...
          '05	パーティー・ライツ （中島）',
          '06	闇夜のテーブル （杉本・宮下）',
          '[text]第３場	リゾート・ホテル～法廷～列車',
          '07	情婦の証言 （中島）',
          '08	ティムを探して （中島）',
          '[text]第４場	列車～廃駅～ミラージュ・ホテル',
          '09	廃線のお知らせ （中島）',
          '10	遺失物預り所 （宮下）',
          '11	水を点して火を汲んで （杉本）',
          '12	ミラージュ・ホテル （中島）',
      ...
      case "y2017":
        return [
          ...
          '06	最悪 （石田）',
          '07	EAST_ASIA （中島）',
          '[text]第6場 「花の色はうつりにけりないたづらにわが身世にふるながめせし間に」',
          '08	船を出すのなら九月 （中村）',
          '[text]第７場 夜会VOL.6「シャングリラ」',
          '09	南三条 （石田）',
          '10	子守歌 （Inst.）',
          '[text]第８場 「問う女」',
          '11	羊の言葉 （中村、石田）',
      ...
      case "y2019":
        return [
          '[text]＜第一幕＞',
          '[text]第１場 ホテル＆パブ・オークマ 2000年12月15日 厳冬期休業開始',
          '01	リトル・トーキョー （Inst.）',
          '02	渡らず鳥 （中島）',
          '03	何か話して （中島）',
          '04	リトル・トーキョー （中島）',
          ...
          '07	BA-NA-NA （石田,植野）',
          '08	カナリア （植野,渡辺）',
          '[text]第２場 ホテル＆パブ・オークマ 2000年12月17日 帰還',
          '09	いつ帰ってくるの （中島）',
          '10	思い出だけではつらすぎる （中島,渡辺）',
          '11	勝ち女 （渡辺）',
          '[text]第３場 ホテル＆パブ・オークマ 2000年12月20日 密猟者情報',
          '12	招かれざる客 （石田）',
          '13	テキーラを飲みほして （石田,植野,渡辺）',
          '14	後悔はないけれど （渡辺,石田）',
          '15	ねぇ、つらら （中島）',
          '[text]第４場 ホテル＆パブ・オークマ 2000年12月23日 クリスマス準備',
          '16	LOVERS_ONLY （中島,渡辺,石田,植野）',
          '[text]第５場 ホテル＆パブ・オークマ 2000年12月28日 捜索難航',
          '17 いつ帰ってくるの （渡辺）',
          '[text]＜第二幕＞',
          '[text]第１場 ホテル＆パブ・オークマ 2000年12月28日 新人参入',
          '18 いつ帰ってくるの （渡辺）',
          '[text]第２場 ホテル＆パブ・オークマ 2000年12月30日 新人研修１',
          '19	氷女 （中島）',
          '20 リトル・トーキョー （渡辺,香坂,中島）',
          '21 ずれてるあたしたち （中島,渡辺,香坂）',
          '[text]第３場 ホテル＆パブ・オークマ 2001年1月8日 新人研修２',
          '22 大人たちはみんな （石田）',
          '[text]第４場 新橋・料亭『華乃家』奥座敷 2000年1月',
          '23 捨て石 （泉谷,中島）',
          '24 紅灯の海 （宮下）',
          '[text]第５場	ホテル＆パブ・オークマ 2001年1月30日 厳冬期休業終了直前',
          '25	梅が枝 （植野）',
